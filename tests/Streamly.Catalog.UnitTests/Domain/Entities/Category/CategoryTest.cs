...
public class CategoryTest(CategoryTestFixture fixture)
{
    ...
    [Fact(DisplayName = nameof(ShouldUpdateCorrectlyOnlyWithTheName))]
    [Trait("Domain", "Category - Aggregates")]
    public void ShouldUpdateCorrectlyOnlyWithTheName()
    {
        #region Arrange
        ...
        #region Assert
            ...
            exampleCategory.Name.Should().Be(exampleCategoryWithNewValues.Name);
            exampleCategory.Description.Should().Be(exampleCategory.Description);
    ...
    [Theory(DisplayName = nameof(ShouldThrowWhenTryUpdateIfNameLessThan3Characters))]
    [Trait("Domain", "Category - Aggregates")]
    [MemberData(nameof(CategoryTestDataGenerator.GetInvalidCategoryNameWithLessThan3Characters), parameters: 10,
        MemberType = typeof(CategoryTestDataGenerator))]
    ...
    [Theory(DisplayName = nameof(ShouldThrowWhenNTryUpdateIfNameGraterThan255Characters))]
    [Trait("Domain", "Category - Aggregates")]
    [MemberData(nameof(CategoryTestDataGenerator.GetInvalidCategoryNameWithMoreThan255Characters), parameters: 10,
        MemberType = typeof(CategoryTestDataGenerator))]
    public void ShouldThrowWhenNTryUpdateIfNameGraterThan255Characters(string invalidName)
    {
        #region Arrange
    ...
    [Fact(DisplayName = nameof(ShouldThrowWhenTryUpdateIfDescriptionGreaterThan10_000Characters))]
    [Trait("Domain", "Category - Aggregates")]
    public void ShouldThrowWhenTryUpdateIfDescriptionGreaterThan10_000Characters()
    {
        #region Arrange
        ...
        #region Act
            ...
            var action =
                () => exampleCategory.Update(exampleCategory.Name, invalidDescription);
